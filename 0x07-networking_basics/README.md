...
This project was the first of two introducing networking concepts. Learning more about the OSI model, different types of network, MAC addresses vs IP addresses, Private and public addresses, IPv4 vs IPv6, TCP vs UDP, what is a ping/ICMP and positional parameters in bash
